...
**screens.folder** | Set up the screenshot folder. Specify either an absolute path or a path relative to your project's root directory | screens.folder = C:\Project\screenshots <br> screens.folder = \screenshots
