...
Any single .btn can be turned into a dropdown toggle with <a href = "https://getbootstrap.com/docs/4.3/components/dropdowns/#single-button">some markup changes</a>. Here’s how you can put them to work with either <button> elements:
